...
const Rating = () => {
  return (
   <section className='mt-20 w-[1340px] h-[302px] mx-auto grid grid-cols-2'>
<div className='flex flex-col mt-7'>
  <p className='text-xl font-extrabold text-gray-600'>Clients Feedback</p>
  <p className='text-5xl font-extrabold text-[#1B1717] leading-tight'>OUR TESTIMONIAL FROM <br></br> BEST CLIENTS</p>
  <p className='text-[#6E6E6E] max-w-[655px] mt-6'>Sed ut perspiciatis unde omnis iste natus error sit
     voluptatem accusantium doloremque laudantium, totam 
     rem aperiam, eaque ipsa quae ab illo inventore veritatis
      et quasi architecto beatae vitae dicta sunt explicabo.</p>
</div>

<div className='fle flex-col w-[655px] h-[302px] p-7 border  border-[#DADADA]'>
...
<p className='text-[#6E6E6E] w-[595px] h-[104px] mt-10 leading-7 '>Sed ut perspiciatis unde omnis iste natus
...
// https://docs.google.com/document/d/1RZeoiwGbYk3jD-BZfqOrlGiFLpEbGL7xYQqu_C7UZ9Y/edit?tab=t.0#heading=h.sgwqlndphpr2